$(document)
		.ready(
				function() {
					...
					$('#account_dropdown').click(function(e) { // not hide when
																// click on
						// dropdown
						e.stopPropagation();
					});

					$('#locale_dropdown').click(function(e) { // not hide when
																// click on
						// dropdown
						e.stopPropagation();
					});
...
function wizardAjaxPostNext(stepUrl, data) {
	jQuery.ajax({
		type : 'POST',
		url : stepUrl,
		data : data + "&methodType=next",
		dataType : 'html',
		async : true,
...
function wizardAjaxPostPrevious(stepUrl, data) {
	jQuery.ajax({
		type : 'POST',
		url : stepUrl,
		data : data + "&methodType=previous",
		dataType : 'html',
		async : true,
		success : function(result) {
			jQuery('#wizard').hide("drop", {
...
function wizardAjaxPostSubmit(stepUrl, redirectUrl, data) {
	jQuery.ajax({
		type : 'POST',
		url : stepUrl,
		data : data + "&methodType=submit",
		dataType : 'html',
		async : true,
		success : function(result) {
			jQuery('#wizard').html(result);
